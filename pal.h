...
#define PAL_SPC5_ODC_MICROSEC_LVDS  PAL_SPC5_ODC(4)
#define PAL_SPC5_SMC                (1UL << 23)
#define PAL_SPC5_ILS_MASK           (3UL << 20)
#define PAL_SPC5_ILS(n)             ((uint32_t)(n) << 20)
#define PAL_SPC5_ILS_AUTO           PAL_SPC5_ILS(0)
#define PAL_SPC5_ILS_TTL            PAL_SPC5_ILS(1)
#define PAL_SPC5_ILS_LVDS           PAL_SPC5_ILS(2)
#define PAL_SPC5_ILS_CMOS           PAL_SPC5_ILS(3)
...
/**
 * @brief   Push-pull gpio pad.
 */
#define PAL_MODE_IO                 (PAL_SPC5_ODC_PUSH_PULL |           \
                                     PAL_SPC5_SMC |                     \
                                     PAL_SPC5_IBE)
 ...
 * @brief   Gpi pad.
 */
#define PAL_MODE_GPI                (PAL_SPC5_IBE)

/**
 * @brief   Push-pull output pad.
 */
#define PAL_MODE_OUTPUT             (PAL_SPC5_ODC_PUSH_PULL |           \
                                     PAL_SPC5_SMC)
/**
 * @brief   Input high-Z pad.
 */
#define PAL_MODE_INPUT              (PAL_SPC5_SMC | PAL_SPC5_IBE)

/**
 * @brief   Port Input pad.
 */
#define PAL_MODE_PI                 (0UL)
/** @} */
 ...
 */
typedef struct {
  spc_mscr_io_init_t  *mscr_io;
  spc_mscr_mux_init_t *mscr_mux;
} PALConfig;
...
/**
 * @brief   I/O port Q identifier.
 */
#define PORT_Q          16U

/**
 * @brief   I/O port R identifier.
 */
#define PORT_R          17U

/**
 * @brief   I/O port S identifier.
 */
#define PORT_S          18U
